...
public class AppSystemTray {
       ...
       imagen=ico;
        if(SystemTray.isSupported()){           //Si es soportado por el sistema
           ...
           try {     
                ...
                itemAbrir.addActionListener(actionAbrir);
                menu.add(itemAbrir);
   ...
   /////////////////Acciones 
        ...
        ActionListener actionAbrir= new ActionListener(){
        @Override
        public void actionPerformed(ActionEvent ae) {
            if(vPrincipal.getExtendedState() == JFrame.ICONIFIED){
                vPrincipal.setVisible(true);
                vPrincipal.setExtendedState(JFrame.NORMAL);
                vPrincipal.repaint();
